...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void updatePointsText() {
        textViewPlayer1.setText(String.format(getResources()
                .getString(R.string.player_1),  player1Points));
        textViewPlayer2.setText(String.format(getResources()
                .getString(R.string.player_2),  player2Points));
    }
